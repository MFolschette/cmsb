...
which implies that the inferred IG contains no unsigned interactions, and thus can be seen as the
...
\label{pps:param_K}
Let $(\PHs, \PHl, \PHh)$ be a Process Hitting well-defined for parameter inference, and $\IG = (\Gamma,
