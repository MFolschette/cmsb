...
\begin{align}
\begin{split}
\forall b\in \PHpredecgene{a} &,
	\forall (i,j\in\levelsA{b}{a} \vee i,j\in\levelsI{b}{a}), \\
& \qquad	\forall c, ( (b\neq a\wedge c=a) \vee (c\in\PHpredec{a} \wedge b\in\PHpredec{c})), \\
& \qquad \qquad
...
where the focals reachability property can by derived from \pref{pro:wf-ph-K} and
