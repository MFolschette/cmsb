...
Regulatory phenomena play a crucial role in biological systems and they need to be studied accurately.
...
We proceed to an exhaustive search for the possible interactions on one component from all the
...
These enumerative searches are made tractable thanks to the use of the Answer-Set Programming (ASP) method.
...
PH from a BRN (which was done in \cite{PMR10-TCSB}) but, on the contrary to finding out
