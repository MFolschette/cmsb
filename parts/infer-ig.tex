...
Finally, if there is a configuration such that the focal level of any $a_i\in L_a$ is $a_i$ itself, we
...
\begin{example*}
\todo{Which example? \pref{fig:runningPH-1}? \pref{fig:runningPH-2}? How far?}
\end{example*}
