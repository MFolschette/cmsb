...
A PH is well-formed for BRN inference if and only if all the following condition are verified:
\begin{itemize}
\item 
...
let us define two sub-states $\sigma,\sigma'\in \prod_{c\in\PHpredecgene{a}} S_c$ such that
