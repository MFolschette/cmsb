...
$\ctx$ (\pref{eq:PHa-ctx}).
\begin{equation}
\PHa(a,\ctx) = \{ \PHfrappe{b_i}{a_j}{a_k}\in\PHa \mid b_i\in\ctx \}
\label{eq:PHa-ctx}
\end{equation}
...
\[V = \{(a_j,a_k)\in (\PHl_a \times \PHl_a) \mid 
...
\begin{equation}
\forall a \in \PHs, \PHdirectpredec{a} = \{b \in \PHs \mid \exists \PHfrappe{b_i}{a_j}{a_k}\in\PHa \}
