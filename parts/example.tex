...
The current implementation can successfully solve the examples given in \pref{fig:runningPH-1}
and \pref{fig:runningPH-2}. It can also handle bigger models found in the literature such as
an ERBB receptor-regulated G1/S transition model from \cite{Sahin09} which contains 20
...
For both models, IG and parameters inferences are performed together in less than a second on a personal
laptop \footnote{Using a Dell Inspiron 1720 laptop, with an Intel Core 2 Duo CPU T5550 ($2 \times 1.83\text{GHz}$)
and 3.9 Gib memory, on an Ubuntu 11.10 64-bits OS}, and the same models without cooperations
