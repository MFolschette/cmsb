...
The current implementation can successfully solve the examples given in \pref{fig:runningPH-1} (with
an incomplete Parametrization) and \pref{fig:runningPH-2}. It can also handle bigger models such as
...
\todo{dire que les modèles en PH sont fournis avec Pint, peut être en footnote}
