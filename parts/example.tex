...
which can also be seen as the IG in \pref{fig:runningBRN}, as its fourth component is an empty set.
...
Applied to the examples given in \pref{fig:runningPH-1} and \pref{fig:runningPH-2}, our method
infers the IG given in \pref{fig:runningBRN} in both cases, and the parameters given in
\pref{fig:examples-param}. In the case of PH in \pref{fig:runningPH-1}, the inferred Parametrization
...
\pref{fig:runningPH-1} and \pref{fig:runningPH-2}.
A question mark denotes a non-conclusive parameter inference.
}
\end{figure}

\todo{dire que l'on infere le IG \pref{fig:runningBRN} et donner les
