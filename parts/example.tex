...
infers the IG given in \pref{fig:runningBRN-ig} in both cases, and the parameters given in
...
\todo{dire que l'on infere le IG \pref{fig:runningBRN-ig} et donner les
