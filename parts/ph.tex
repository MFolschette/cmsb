...
Two examples of Process Hitting modeling a BRN at different abstraction levels are given.
...
This Process Hitting example actually models a BRN where the component $a$ has three qualitative
