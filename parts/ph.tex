...
Process Hitting resulting from the refinement of the one in \pref{fig:runningPH-1} by the
...
\begin{example*}
The Process Hitting in \pref{fig:runningPH-2} results from the refinement of the Process Hitting in 
