...
\begin{example*}
In the BRN that consists in the IG and Parametrization of \pref{fig:runningBRN}, the following transitions are possible given the dynamics defined in \pref{def:dynamics}:
