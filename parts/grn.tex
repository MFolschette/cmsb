...
inference), we extend the classical formalism by setting parameters to interval of values instead of a single
...
we look for obtaining three different parameters $K_{a,A_1,B_1} = i_1$,  $K_{a,A_2,B_2} = i_2$, 
$K_{a,A_3,B_3} = i_3$.
...
We also remark that the use of intervals makes optional the some explicit auto-activations in the IG
