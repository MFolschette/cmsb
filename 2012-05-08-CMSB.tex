...
specific restriction on the causality between actions.
In particular, the PH is suitable to model Biological Regulatory Networks (BRNs) with partial or
complete knowledge of the cooperations between regulators by defining the most permissive dynamics
...
cooperations, where Thomas' approach fails because of the combinatoric of possible parameters.
\end{abstract}
